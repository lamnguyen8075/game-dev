...
public class SpawnManager extends GameObject {
	...
	private static final int CLOUD_OBSTACLE_WIDTH = 30, CLOUD_OBSTACLE_HEIGHT = 60;
	...
	void spawnCloudObstacle() {
		new CloudObstacle(CLOUD_OBSTACLE_WIDTH, CLOUD_OBSTACLE_HEIGHT);
	}
